...
const StandaloneScreenshot = styled.div`
  width: auto;
  height: 10em;
  right: -6em;
  top: -5em;
...
export function TopSection() {
  return (
    <TopSectionContainer>
      <LeftContainer>
        <Slogan>
          Learn Better. <br /> Debug Less.
        </Slogan>
        <Description>
          Creators put a lot of effort into their videos for them to just be out
          of date once new versions of packages come out. In turn, students are
